...
python training_ROI_classifier.py --learning_rate 3e-4 --momentum 0.99 --model ROI_classifier_fold3 --device 1 --epochs 120 --num_extra_steps 0 --train_data ROI_classifier_fold2_expert_train --val_data ROI_classifier_fold2_expert_val --num_slices 9 --hidden_blocks 1 2 6 8 12 4 --use_3d_prediction --use_async_sampler