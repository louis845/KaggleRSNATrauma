...
# validation dataset
python stage1_organ_segmentation.py --model ROI_stage1_fold1 --device 0 --memory_limit 0.495 --dataset ROI_classifier_fold0_val --hidden_blocks 1 2 6 8 19 4
# training dataset
python stage1_organ_segmentation.py --model ROI_stage1_fold1 --device 0 --memory_limit 0.495 --dataset ROI_classifier_fold0_train --hidden_blocks 1 2 6 8 19 4